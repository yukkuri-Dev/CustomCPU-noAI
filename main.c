...
int logo(){
 printf("Custom CPU Emulator v0.1.1-timer\n");
 printf("\n");
...
int Run() {
    if (CPU_GPR[0] == 0x00000001) { // ADD
        CPU_GPR[4] = CPU_GPR[1] + CPU_GPR[2];

    } else if (CPU_GPR[0] == 0x00000002) { // SUB
        CPU_GPR[4] = CPU_GPR[1] - CPU_GPR[2];
    } else if (CPU_GPR[0] == 0x00000010){ // MOV
    ...
    }else if (CPU_GPR[0] == 0x00000031){ // JZ
        if(CPU_GPR[3] == 0){
    ...
    } else if (CPU_GPR[0] == 0x00000040){ // AND
        CPU_GPR[4] = CPU_GPR[1] & CPU_GPR[2];
    } else if (CPU_GPR[0] == 0x00000041){ // OR
        CPU_GPR[4] = CPU_GPR[1] | CPU_GPR[2];
    } else if (CPU_GPR[0] == 0x00000042){ // XOR
        CPU_GPR[4] = CPU_GPR[1] ^ CPU_GPR[2];
    } else if (CPU_GPR[0] == 0x00000045){//Not
        CPU_GPR[4] = ~CPU_GPR[1];
    } else if (CPU_GPR[0] == 0xFFFFFFFF) { // エミュレーター用強制停止命令
        ...
        printf("OK?\n");
        return -1;
    }else if(CPU_GPR[0] == 0x0FFFFFFF){//DEBUG PRINT
        printf("[Debug]register %02X's value:%08X\n", CPU_GPR[1], CPU_GPR[CPU_GPR[1]]);
    }else if (CPU_GPR[0] == 0x00000000){ // NOP
        // Do nothing
